  ...
  offer: [
    {
      ...
      text: "Собираю вводные, фиксирую границы проекта и превращаю ожидания в понятный план работ.",
    },
    {
      title: "Управление исполнением",
      text: "Делю работу на понятные задачи, показываю статус, снимаю блокеры и помогаю команде двигаться без лишней путаницы.",
    },
    {
