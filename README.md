...
В репозиторий не нужно добавлять секреты, токены, пароли, приватные ключи, личные архивы, служебные файлы Codex, приватные репозитории и закрытые ссылки. Телефон на сайте не публикуется; контактные данные ограничены email и Telegram.
