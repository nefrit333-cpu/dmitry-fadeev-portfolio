...
- блок «Обо мне» с новым editorial-портретом, метриками и компактным подтверждением обучения;
...
Для UI-изменений дополнительно проверяются desktop и mobile viewport: отсутствие горизонтального скролла, читаемость карточек, работа burger-меню, формы и корректность ссылок.
